...
export const factCategories: FactCategory[] = [
  ...
  {
    id: "rebuttals",
    name: "Debunked Studies",
    nameNo: "Tilbakeviste studier",
    icon: "🔬",
    description: "DARI rebuttals of flawed academic studies about Bitcoin mining",
    descriptionNo: "DARI-tilbakevisninger av feilaktige akademiske studier om Bitcoin-mining",
  },
];
...
export const facts: Fact[] = [
  ...
  // ============================================================
  // DARI REBUTTALS — Debunked Studies
  // ============================================================
  {
    id: "rebuttal-1",
    category: "rebuttals",
    claim: "Bitcoin mining is incompatible with sustainable development (Çelik & Özırmak 2025)",
    claimNo: "Bitcoin-mining er uforenlig med bærekraftig utvikling (Çelik & Özırmak 2025)",
    reality:
      "The study relies heavily on discredited sources like Mora et al. (2018) and de Vries' 2018 estimates. It ignores that 56.7% of Bitcoin's energy mix comes from sustainable sources (2024), that over 86% of decommissioned miners are reused or recycled (actual 2024 e-waste ~2.3 kilotons), and that Bitcoin mining acts as flexible demand stabilizing grids. Outdated geographic claims about coal concentration don't reflect post-2021 redistribution to renewable-rich regions.",
    realityNo:
      "Studien bygger tungt på avkreftede kilder som Mora et al. (2018) og de Vries' estimater fra 2018. Den ignorerer at 56,7 % av Bitcoins energimiks kommer fra bærekraftige kilder (2024), at over 86 % av avviklede minere gjenbrukes eller resirkuleres, og at Bitcoin-mining fungerer som fleksibel etterspørsel som stabiliserer strømnett.",
    source: "DARI – Dr. Simon Collins",
    sourceUrl: "https://www.da-ri.org/rebuttal/celikandozirmaks",
    date: "2025",
    tip: "This study cites Mora et al. who claimed Bitcoin alone could cause 2°C warming — thoroughly debunked. It also ignores that 86% of ASICs are reused or recycled.",
    tipNo: "Studien siterer Mora et al. som påstod Bitcoin alene kunne forårsake 2°C oppvarming — grundig avkreftet. Den ignorerer også at 86 % av ASIC-er gjenbrukes.",
  },
  {
    id: "rebuttal-2",
    category: "rebuttals",
    claim: "Bitcoin mining causes significant PM2.5 pollution in the US (Dominici et al. / 'Harvard Study' 2025)",
    claimNo: "Bitcoin-mining forårsaker betydelig PM2.5-forurensning i USA (Dominici et al. / 'Harvard-studien' 2025)",
    reality:
      "The Nature Communications study attributes emissions based on regional balancing authorities rather than actual contractual power sources. It misuses WattTime's MOER methodology (designed for short-term grid responses, not long-term structural changes). Only 34 of 137 US mining operations were analyzed, excluding renewable-heavy operations like Marathon's 114 MW wind farm and Crusoe's flare-gas mitigation. 2018 EPA data was used to analyze 2022–2023 operations.",
    realityNo:
      "Nature Communications-studien tilskriver utslipp basert på regionale balanseringsmyndigheter i stedet for faktiske kontraktsfestede strømkilder. Den misbruker WattTimes MOER-metodologi. Kun 34 av 137 amerikanske mining-operasjoner ble analysert, og fornybar-tunge operasjoner som Marathons 114 MW vindpark og Crusoes gassoppsamling ble ekskludert.",
    source: "DARI",
    sourceUrl: "https://www.da-ri.org/rebuttal/rebuttal-dominici-et-al-2025",
    date: "April 2025",
    tip: "The 'Harvard study' analyzed only 34 of 137 miners — deliberately excluding the most sustainable ones. That's like estimating car industry emissions by only measuring SUVs.",
    tipNo: "«Harvard-studien» analyserte bare 34 av 137 minere — og utelot bevisst de mest bærekraftige. Det er som å anslå utslipp fra bilbransjen ved kun å måle SUV-er.",
  },
  {
    id: "rebuttal-3",
    category: "rebuttals",
    claim: "Bitcoin mining has severe impacts on energy and water resources (Radulescu et al. 2025)",
    claimNo: "Bitcoin-mining har alvorlige konsekvenser for energi- og vannressurser (Radulescu et al. 2025)",
    reality:
      "The study relies on Cambridge estimates over three years old and previously debunked de Vries publications (2018–2021). Water consumption claims are misleading because much of the water attributed to Bitcoin mining is neither freshwater nor permanently consumed — closed-loop cooling systems and recycled water are standard. 15 of 17 major peer-reviewed articles show positive or neutral impact on renewable energy integration.",
    realityNo:
      "Studien baserer seg på Cambridge-estimater som er over tre år gamle og tidligere avkreftede publikasjoner fra de Vries. Vannforbruks-påstandene er misvisende fordi mye av vannet tilskrevet mining verken er ferskvann eller permanent forbrukt. 15 av 17 store fagfellevurderte artikler viser positiv eller nøytral påvirkning på fornybar energi-integrering.",
    source: "DARI – Dr. Simon Collins",
    sourceUrl: "https://www.da-ri.org/rebuttal/re-examining-bitcoin-minings-environmental-impact-a-rebuttal-to-radulescu-et-al-2025",
    date: "March 2025",
    tip: "15 of 17 peer-reviewed studies show positive or neutral effects from Bitcoin mining on renewable energy. This study chose to ignore all of them.",
    tipNo: "15 av 17 fagfellevurderte studier viser positive eller nøytrale effekter fra Bitcoin-mining på fornybar energi. Denne studien valgte å ignorere dem alle.",
  },
  {
    id: "rebuttal-4",
    category: "rebuttals",
    claim: "Bitcoin mining creates counter-incentives for investing in storage and grid infrastructure (Gill et al.)",
    claimNo: "Bitcoin-mining skaper motinsentiver for investering i lagring og nettinfrastruktur (Gill et al.)",
    reality:
      "Gill et al. rely on discredited researchers (de Vries, Mora) and 2022 Cambridge Index data. E-waste estimates use a debunked 1.56-year mining equipment lifespan — actual lifespan is at least four times longer with robust secondary markets. Static equilibrium modeling ignores Bitcoin's difficulty adjustment. Duke University research shows mining actually avoids unnecessary grid upgrades.",
    realityNo:
      "Gill et al. baserer seg på avkreftede forskere (de Vries, Mora) og 2022 Cambridge Index-data. E-avfall-estimatene bruker en tilbakevist levetid på 1,56 år for mining-utstyr — faktisk levetid er minst fire ganger lengre. Duke University-forskning viser at mining faktisk unngår unødvendige nettoppgraderinger.",
    source: "DARI – Dr. Simon Collins",
    sourceUrl: "https://www.da-ri.org/rebuttal/self-limited-economists",
    date: "2025",
    tip: "Gill et al. use a 1.56-year lifespan for mining equipment — debunked by the entire industry. Actual lifespan is 6+ years. That's like claiming cars are scrapped after 18 months.",
    tipNo: "Gill et al. bruker en levetid på 1,56 år for mining-utstyr — tilbakevist av hele bransjen. Faktisk levetid er 6+ år. Det er som å hevde at biler skrotes etter 18 måneder.",
  },
  {
    id: "rebuttal-5",
    category: "rebuttals",
    claim: "Bitcoin uses more water than entire countries and has massive carbon footprint (UN University / Chamanara et al. 2023)",
    claimNo: "FN-universitetet: Bitcoin bruker mer vann enn hele land og har massivt karbonfotavtrykk (Chamanara et al. 2023)",
    reality:
      "The UN study uses outdated Cambridge data and de Vries' peer-review debunked methodology. Water calculations include indirect water use in power generation (cooling water) which is not unique to Bitcoin — all electricity consumers share this footprint. Bitcoin mining increasingly uses closed-loop cooling systems, non-potable water, and renewable energy with minimal water needs. Actual direct water consumption is a fraction of what is claimed.",
    realityNo:
      "FN-studien bruker utdaterte Cambridge-data og de Vries' metodologi som er fagfellevurdert avkreftet. Vannberegningene inkluderer indirekte vannforbruk i kraftproduksjon som ikke er unikt for Bitcoin. Bitcoin-mining bruker i økende grad lukkede kjølesystemer og fornybar energi med minimalt vannbehov.",
    source: "DARI rebuttal of UN University study",
    sourceUrl: "https://cdn.prod.website-files.com/627aa615676bdd1d47ec97d4/65b004ac744cd4c6abb8934e_UN%20Paper%20FINAL%20.pdf",
    date: "2024",
    tip: "The UN study counts power plant cooling water as 'Bitcoin's water use' — by that logic, Netflix 'uses' just as much water. That's the power plant's footprint, not Bitcoin's.",
    tipNo: "FN-studien teller kjølevann i kraftverk som «Bitcoins vannforbruk» — med den logikken «bruker» Netflix like mye vann. Det er kraftverkets fotavtrykk, ikke Bitcoins.",
  },
];
